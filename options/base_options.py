...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--resize_size', type=int, default=256, help='Scale images to this size. The final image will be cropped to --crop_size.')
        parser.add_argument('--center_crop_size', type=int, default=512, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        ...
        parser.add_argument('--model_path', type=str, default='/Users/faziletgokbudak/PycharmProjects/ASAPNet-tensorflow/trained_models',
                            help='path where the trained model is saved')
        parser.add_argument('--filter', type=str, default='eye_UM_perpixel', help='filter type applied to label')
